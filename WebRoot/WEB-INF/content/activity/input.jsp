...
<body>
		...
		<div class="row">
			<div class="col-md-10">
				<div class="span12 pub-title">
					<h3 id="tittleid">发布活动</h3>
				</div>
				<form class="form-horizontal " id="activity_form" action=""
					method="post">
					<input type="hidden" id="at_optType" value="${editOpt}"> <input
						type="hidden" name="activity.status" id="at_status" value="-1">
					...
					<div class="form-group">
						...
						<div class="col-sm-8 col-md-6">
							<input type="title" class="form-control" name="activity.name"
								value="${activity.name}" id="at_name" placeholder="活动标题">
						</div>
					</div>
    ...
    -->
						...
						<div class="col-sm-8 col-md-6">
							...
							<select id="address" class="form-control" name="activity.address"
						...
						<div class="col-sm-5">
							...
							<c:forEach var="t" items="${ dtypes}">
								...
								<label class="checkbox-inline"> <c:if
										test="${ fn:contains(activity.type, t.dkey) }">
										<input type="checkbox" name="type" id="inlineCheckbox1"
											value="${t.dkey}" checked="checked">
									</c:if> <c:if test="${! fn:contains(activity.type,t.dkey) }">
										<input type="checkbox" name="type" id="inlineCheckbox1"
											value="${t.dkey}">
									</c:if> ${t.dvalue}
						...
						<div class="col-sm-8 col-md-4">
							...
							<div class="input-group spinner" data-trigger="spinner">
								<input type="text" class="form-control text-left"
									name="activity.joyFee" value="${activity.joyFee}"
									id="at_joyFee" data-rule="quantity">
					...
					<div class="form-group">
						...
						<input type="hidden" id="at_poster" value="${activity.poster}"
							name="activity.poster"> <input type="hidden"
							id="at_thumbnail" value="${activity.thumbnail}"
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-4 col-md-2">
							<button type="button" class="btn m-btn m-btn-primary"
								id="at_submit1">发布</button>
						</div>

						<div class=" col-sm-4 col-md-2">
							<button type="button" class="btn m-btn m-btn-primary"
								id="at_submit2">保存草稿</button>
						</div>
						<!--  
							<div class=" col-sm-4 col-md-2">
	...
	<script type="text/javascript"
		src="<%=path%>resJs/jquery.spinner.min.js"></script>
	<script type="text/javascript"
